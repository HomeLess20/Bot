...
play_schedule = {
    datetime.time(0, 58): "/song/Fe!n - Travis Scott ft.Playboi carti ｜｜ [edit audio].mp3",   #  เล่นตอน
    datetime.time(0, 55): "/song/Fe!n - Travis Scott ft.Playboi carti ｜｜ [edit audio].mp3",    # เล่นตอน 12:00 น.
